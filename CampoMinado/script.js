document.addEventListener('DOMContentLoaded', () => {
  ...
  function onclick(quadrado) {
    ...
    if (derrota) return
    if (
      quadrado.classList.contains('Verificado') ||
      quadrado.classList.contains('Bandeira')
    )
      return
...
//garantia nome da equipe e turma
//Equipe: Enzo Martins, Luis Carlos, Letícia Ferreira
